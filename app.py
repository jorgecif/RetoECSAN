		...
		if input_string1=='18':
			...
			if input_string2=='blanco':
				...
				if input_string3=='pensar':
					...
					st.subheader(' ')
					st.markdown('Ingresa a <a href="https://youtu.be/zTY2gveh4zQ" target="_blank">https://youtu.be/zTY2gveh4zQ</a>  el viernes 5 de marzo a las 4:00 pm y te enterarás cómo convertir tu investigación de grado en un proyecto de innovación.', unsafe_allow_html=True)
