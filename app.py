...
def main():
	...
	if session_state.button_sent:
		...
		st.image(triangulos, caption='Triángulos', use_column_width=True)

		input_string1 = st.text_input("Tu respuesta al reto 1")
		if input_string1=='18':
			...
			input_string2 = st.text_input("Tu respuesta al reto 2")
			if input_string2=='blanco':
				...
				st.subheader("Gente que tenía que moverse para _______")

				input_string3 = st.text_input("Tu respuesta al reto 3")
